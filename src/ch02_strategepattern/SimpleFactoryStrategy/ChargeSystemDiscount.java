package ch02_strategepattern.SimpleFactoryStrategy;
    ...
    private void initialize() {
        ...
        btnOk.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                double totalPrice = 0;
                CashContext csuper = new CashContext(cbxType.getSelectedItem().toString());
                totalPrice = csuper.GetResult(Double.valueOf(txtPrice.getText()) * Double.valueOf(txtNum.getText()));
