package ch02_strategepattern.strategechargesystem;
        ...
        btnOk.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                switch (cbxType.getSelectedItem().toString()) {
                    case "正常收费":
                        cc = new CashContext(new CashNorml());
                        break;
                    case "满300返100":
                ...
                totalPrice = cc.GetResult(Double.valueOf(txtPrice.getText()) * Double.valueOf(txtNum.getText()));
